    ...
    <nav id="header" className="w-full z-30 top-10 py-1 bg-white shadow-lg ">
      <div className="w-full flex items-center justify-between mt-0 px-6 py-2">
        ...
        <div className="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
          <nav>
            <ul className="md:flex items-center justify-between text-base text-red-600 pt-4 md:pt-0">
        ...
        <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
          <div className="auth flex items-center w-full md:w-full">
            ...
            <button className="bg-red-600 text-gray-200  px-2 py-1 rounded  hover:bg-red-500 hover:text-gray-100">Sign up</button>
          </div>
        </div>
      </div>
    </nav>
